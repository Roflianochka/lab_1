...
links.addEventListener("click", function (event) {
  ...
  links.text = language.toUpperCase();
...
function getTranslate() {
  ...
  elements.forEach((element) => {
    ...
    if (
      i18n.hasOwnProperty(language) &&
      i18n[language].hasOwnProperty(translationKey)
    ) {
...
const i18n = {
  en: {
    ...
    navLogin: "Login",
    mainHeader:
      "Give your team peace of mind with supplemental health insurance from Brella.",
    mainParagraph: "I'm wondering...",
    mainEmailPlaceholder: "how Brella's plan works",
    mainFindOut: "Find out",
    Morecoverage: "More coverage",
    MorecoverageDesc:
      "Brella covers 13,000+ injuries and illnesses from concussions to cancer",
    Fasterbenefits: "Faster benefits",
    FasterbenefitsDesc:
      "One easy-to-manage plan with paperless install and online admin tools",
    Lesshassle: "Less hassle",
    LesshassleDesc:
      "Brella pays claims in hours–not weeks so your people can rest easy",
    WhyBrella: "Why Brella?",
    HealthInsuranceDeductible:
      "Today, any health insurance deductible can feel like a high deductible.",
    HealthBenefitStrategy:
  ...
  ru: {
    ...
    navLogin: "Вход",
    mainHeader:
      "Предоставьте вашей команде покой с дополнительным медицинским страхованием от Brella.",
    ...
    MorecoverageDesc:
      "Brella охватывает 13 000+ травм и заболеваний, от сотрясений до рака",
    Fasterbenefits: "Быстрые выплаты",
    FasterbenefitsDesc:
      "Один легкоуправляемый план с бесбумажной установкой и онлайн-административными инструментами",
    Lesshassle: "Меньше хлопот",
    LesshassleDesc:
      "Brella выплачивает средства в течение часов, а не недель, так что ваши сотрудники могут спать спокойно",
    WhyBrella: "Почему Brella?",
    HealthInsuranceDeductible:
      "Сегодня любой страховой дедакт может показаться высоким дедактом.",
    HealthBenefitStrategy:
      "Супердополнительная страховая программа Brella улучшает вашу стратегию по обеспечению здоровья, чтобы обеспечить, что здоровотрудности не становятся финансовыми бременами.",
    Seeourplan: "Посмотреть наш план",
    BrellaBrings: "Brella предлагает",
    Customizablebenefits: "Настроенные преимущества",
    Paperlessinstalladmin:
      "Установка и администрирование без бумажной документации",
    ...
    BrellaPlanBenefits:
      "Каждый план Brella поставляется с пользой для умеренных, тяжелых и катастрофических состояний. Сотрудники могут выбрать суммы выплат, соответствующие их потребностям и бюджету.",
    EmployersCanFund:
      "Работодатели могут финансировать часть или все страховые взносы — или предлагать Brella как добровольное поощрение. Выбор за вами.",
    Oneplanmorecoverage: "Один план, больше покрытия",
    Noonecanpredict:
      "Никто не может предсказать, с какими здоровотрудностями они столкнутся.",
    SupplementalCoverage:
      "Наше широкое супердополнительное покрытие избавляет от догадок и кладет деньги в карманы вашей команды для большинства состояний, требующих срочной медицинской помощи.",
    CoveredInjuriesIllnesses: "5K",
    FracturesAppendicitis:
      "покрытые травмы и заболевания от переломов и аппендицита до рака",
    MoreCoveredConditions: "1X",
    AccidentCriticalIllness:
      "больше покрытых состояний, чем в планах по несчастным случаям и критическим заболеваниям — в совокупности",
    GuaranteedIssue: "40%",
    NoMedicalUnderwriting:
      "100% гарантированный выпуск планов. Не требуется медицинское страхование",
    ZeroLimitations: "0",
    NoLimitationsExclusions:
      "Нулевые ограничения или исключения для предварительных состояний",
    BetterClaimsExperience: "Лучший опыт подачи заявок",
    PlanPaysInHours:
      "Предоставьте своей команде план, который выплачивает в течение часов, а не недель.",
    FileAClaimSooner:
      "Вашей команде не терпится получить душевное спокойствие. Brella выплачивает средства при диагнозе, поэтому участники могут подать заявку раньше и получить выплату быстрее через наш Портал участника или мобильное приложение.",
    PlayVideo: "Смотреть видео",
    bg: "Фон",
    forEmployers: "для работодателей",
    easyEnrollment: "Простая регистрация встречает простое управление.",
    paperlessImplementation:
      "Brella предлагает 100% безбумажную реализацию, регистрацию и администрирование. Подключитесь к нашим платформам или мы подключимся к вашим.",
    learnMore: "Узнать больше",
    proudlyBacked: "С гордостью поддерживается",
    podcast: "Подкаст",
    betterVoluntaryBenefits:
      "Лучшие добровольные бенефиты с лидером практики добровольных бенефитов NFP, Ким Хилд",
    ...
    latestText:
      "Подпишитесь, чтобы получать новости и аналитику по льготам в вашем почтовом ящике раз в месяц.",
    ...
    footerText2:
      "Brella страхуется Greenhouse Life Insurance Company (NAIC 80055). Форма № PFSB11-TX",
    footerText3:
      "Свяжитесь с нами по адресу: 2093 Philadelphia Pike #2496, Клеймонт, штат Делавэр, 19703, и по телефону: (844) 987-1070",
